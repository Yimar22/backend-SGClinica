...
public class UserControllerTest {
    ...
    public void createUser_sinNingunDato_retornaErroresDeValidacion() {
        ResponseEntity<ValidationErrors> response = register(new UserRegisterRequestModel(),
    ...
    @Test
    public void createUser_sinNombre_retornaMensajeDeErroresDeValidacionParaElNombre() {
        UserRegisterRequestModel user = TestUtil.createValidUser();
        user.setName(null);
        ResponseEntity<ValidationErrors> response = register(user,
                ValidationErrors.class);
    ...
    @Test
    public void createUser_sinEmail_retornaMensajeDeErroresDeValidacionParaElEmail() {
        UserRegisterRequestModel user = TestUtil.createValidUser();
        user.setEmail(null);
        ResponseEntity<ValidationErrors> response = register(user,
                ValidationErrors.class);
    ...
    @Test
    public void createUser_sinPassword_retornaMensajeDeErroresDeValidacionParaElPassword() {
        UserRegisterRequestModel user = TestUtil.createValidUser();
        user.setPassword(null);
        ResponseEntity<ValidationErrors> response = register(user,
                ValidationErrors.class);
    ...
    public void createUser_conUsuarioValido_retornaOK() {
        UserRegisterRequestModel user = TestUtil.createValidUser();
        ResponseEntity<UserRest> response = register(user,
                UserRest.class);
    ...
    @Test
    public void createUser_conUsuarioValido_guardaElPasswordConHashEnLaBD() {
        UserRegisterRequestModel user = TestUtil.createValidUser();
        ResponseEntity<UserRest> response = register(user,
                UserRest.class);
        UserEntity userDB = userRepository.findById(response.getBody().getId());
    ...
    public void createUser_conUsuarioValidoConCorreoElectronicoExistente_retornaBadRequest() {
        ...
        register(user,
                UserRest.class);
        ResponseEntity<UserRest> response2 = register(user,
                UserRest.class);
    ...
    @Test
    public void createUser_conUsuarioValidoConCorreoElectronicoExistente_retornaMensajeDeErroresDeValidacionParaElEmail() {
        UserRegisterRequestModel user = TestUtil.createValidUser();
        register(user,
                UserRest.class);
        ResponseEntity<ValidationErrors> response2 = register(user,
                ValidationErrors.class);
    ...
    public void getUser_conTokenDeAutenticacion_retornaOK() {
        ...
        ResponseEntity<Map<String, String>> responseLogin = login(model,
