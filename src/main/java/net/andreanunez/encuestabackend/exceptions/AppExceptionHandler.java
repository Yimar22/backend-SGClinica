package net.andreanunez.encuestabackend.exceptions;
...
/**
 * Esta clase ayuda a realizar la validación del modelo con ayuda de la clase
 * ValidatonErrors (responses)
 */
@ControllerAdvice
public class AppExceptionHandler {
    ...
    public ResponseEntity<Object> handleValidationErrorException(MethodArgumentNotValidException ex,
        ...
        // Errores que se le van a retornar al cliente, los guardamos en un Map
